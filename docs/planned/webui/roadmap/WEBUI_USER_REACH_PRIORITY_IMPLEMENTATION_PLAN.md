...
- `docs/planned/webui/performance/WEBUI_PERFORMANCE_UX_IMPROVEMENT_PLAN.md`
- `docs/planned/webui/native-parity/WEBUI_TUI_NATIVE_FEATURE_PLAN.md`
- `lib/WEBUI_TUI_NATIVE_PARITY.json`
- `docs/planned/webui/optional-features/OPTIONAL_FEATURE_MINIMAL_WEBUI_IMPLEMENTATION_PLAN.md`
