...
- `@firstpick/pi-extension-aur-review` — Deterministic manual repository/Git review with working-tree standalone snapshots, staged Guided Git snapshots, and a specialized browser card. Install from `/home/firstpick/npm-packages/pi-extension-aur-review` locally for now; npm installation is valid only after publication.
