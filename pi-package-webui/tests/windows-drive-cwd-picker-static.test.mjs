...
assert.match(html, /app\.js\?v=182/, "the changed picker behavior should advance the app revision");
assert.match(serviceWorker, /pi-webui-pwa-v153/, "the changed browser assets should advance the PWA cache identity");
