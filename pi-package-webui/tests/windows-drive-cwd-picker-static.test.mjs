...
assert.match(html, /app\.js\?v=175/, "the changed picker behavior should advance the app revision");
assert.match(serviceWorker, /pi-webui-pwa-v142/, "the changed browser assets should advance the PWA cache identity");
