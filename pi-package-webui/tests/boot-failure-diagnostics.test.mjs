...
function makeEnvironment({
  ...
  const styleLink = new FakeElement({ href: "http://127.0.0.1:31415/styles.css?v=97", sheet: stylesheetLoaded ? {} : null });
  ...
  const document = {
    currentScript: new FakeElement({ dataset: { appSrc: "/app.js?v=111" } }),
    readyState: "complete",
...
assert.ok(html.indexOf('id="webuiBootLoader"') < html.indexOf("/app.js?v=111"), "the inline loader should own app module startup");
