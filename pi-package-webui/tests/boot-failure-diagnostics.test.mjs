...
function makeEnvironment({
  ...
  const document = {
    currentScript: new FakeElement({ dataset: { appSrc: "/app.js?v=152" } }),
    readyState: "complete",
...
assert.ok(html.indexOf('id="webuiBootLoader"') < html.indexOf("/app.js?v=152"), "the inline loader should own app module startup");
