...
function makeEnvironment({ importApp, stylesheetLoaded = true, stylesheetStatus = 200, workflowModuleStatus = 404 } = {}) {
  ...
  const document = {
    currentScript: new FakeElement({ dataset: { appSrc: "/app.js?v=92" } }),
    readyState: "complete",
...
assert.ok(html.indexOf('id="webuiBootLoader"') < html.indexOf("/app.js?v=92"), "the inline loader should own app module startup");
