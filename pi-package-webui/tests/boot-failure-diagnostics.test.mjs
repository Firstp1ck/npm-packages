...
function makeEnvironment({ importApp, stylesheetLoaded = true, stylesheetStatus = 200, workflowModuleStatus = 404 } = {}) {
  ...
  const styleLink = new FakeElement({ href: "http://127.0.0.1:31415/styles.css?v=92", sheet: stylesheetLoaded ? {} : null });
  ...
  const document = {
    currentScript: new FakeElement({ dataset: { appSrc: "/app.js?v=103" } }),
    readyState: "complete",
...
assert.ok(html.indexOf('id="webuiBootLoader"') < html.indexOf("/app.js?v=103"), "the inline loader should own app module startup");
