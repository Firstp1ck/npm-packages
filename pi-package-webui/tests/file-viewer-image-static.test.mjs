...
assert.match(serviceWorker, /const CACHE_NAME = "pi-webui-pwa-v108"/, "changed viewer assets should advance the PWA cache identity");
assert.match(html, /styles\.css\?v=123/, "changed image styles should advance the stylesheet revision");
assert.match(html, /app\.js\?v=146/, "changed image rendering should advance the app revision");
