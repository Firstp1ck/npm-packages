...
assert.match(serviceWorker, /const CACHE_NAME = "pi-webui-pwa-v112"/, "changed viewer assets should advance the PWA cache identity");
assert.match(html, /styles\.css\?v=126/, "changed image styles should advance the stylesheet revision");
