...
assert.match(serviceWorker, /const CACHE_NAME = "pi-webui-pwa-v145"/, "continuity/tablet assets need a coherent cache identity");
assert.match(html, /styles\.css\?v=145/, "tablet CSS must have a coherent HTML revision");
assert.match(html, /app\.js\?v=177/, "continuity app logic must have a coherent HTML revision");
