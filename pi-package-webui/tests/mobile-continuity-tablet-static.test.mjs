...
assert.match(serviceWorker, /const CACHE_NAME = "pi-webui-pwa-v83"/, "continuity/tablet assets need a coherent cache identity");
assert.match(html, /styles\.css\?v=106/, "tablet CSS must have a coherent HTML revision");
