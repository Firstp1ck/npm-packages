...
assert.match(serviceWorker, /const CACHE_NAME = "pi-webui-pwa-v116"/, "continuity/tablet assets need a coherent cache identity");
assert.match(html, /styles\.css\?v=130/, "tablet CSS must have a coherent HTML revision");
assert.match(html, /app\.js\?v=151/, "continuity app logic must have a coherent HTML revision");
