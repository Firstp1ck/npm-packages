...
assert.match(serviceWorker, /const CACHE_NAME = "pi-webui-pwa-v113"/, "continuity/tablet assets need a coherent cache identity");
assert.match(html, /styles\.css\?v=127/, "tablet CSS must have a coherent HTML revision");
