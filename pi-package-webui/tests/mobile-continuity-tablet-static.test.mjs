...
assert.match(serviceWorker, /const CACHE_NAME = "pi-webui-pwa-v104"/, "continuity/tablet assets need a coherent cache identity");
assert.match(html, /styles\.css\?v=122/, "tablet CSS must have a coherent HTML revision");
assert.match(html, /app\.js\?v=142/, "continuity app logic must have a coherent HTML revision");
