...
assert.match(serviceWorker, /const CACHE_NAME = "pi-webui-pwa-v130"/, "continuity/tablet assets need a coherent cache identity");
assert.match(html, /styles\.css\?v=137/, "tablet CSS must have a coherent HTML revision");
assert.match(html, /app\.js\?v=164/, "continuity app logic must have a coherent HTML revision");
