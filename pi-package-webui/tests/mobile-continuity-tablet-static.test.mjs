...
assert.match(serviceWorker, /const CACHE_NAME = "pi-webui-pwa-v73"/, "continuity/tablet assets need a coherent cache identity");
assert.match(html, /styles\.css\?v=98/, "tablet CSS must have a coherent HTML revision");
assert.match(html, /app\.js\?v=113/, "continuity app logic must have a coherent HTML revision");
