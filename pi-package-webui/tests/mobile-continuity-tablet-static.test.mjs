...
assert.match(serviceWorker, /const CACHE_NAME = "pi-webui-pwa-v107"/, "continuity/tablet assets need a coherent cache identity");
assert.match(html, /styles\.css\?v=123/, "tablet CSS must have a coherent HTML revision");
assert.match(html, /app\.js\?v=145/, "continuity app logic must have a coherent HTML revision");
