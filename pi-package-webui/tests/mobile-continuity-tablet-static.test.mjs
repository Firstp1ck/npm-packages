...
assert.match(serviceWorker, /const CACHE_NAME = "pi-webui-pwa-v118"/, "continuity/tablet assets need a coherent cache identity");
assert.match(html, /styles\.css\?v=131/, "tablet CSS must have a coherent HTML revision");
assert.match(html, /app\.js\?v=152/, "continuity app logic must have a coherent HTML revision");
