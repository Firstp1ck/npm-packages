...
assert.match(html, /\/styles\.css\?v=132/, "integrated stylesheet changes should advance the cache query");
assert.match(html, /\/app\.js\?v=157/, "integrated app changes should advance the cache query");
