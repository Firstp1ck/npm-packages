...
assert.match(html, /\/styles\.css\?v=133/, "integrated stylesheet changes should advance the cache query");
assert.match(html, /\/app\.js\?v=158/, "integrated app changes should advance the cache query");
