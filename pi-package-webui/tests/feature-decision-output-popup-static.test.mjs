...
assert.match(html, /\/styles\.css\?v=117/, "integrated stylesheet changes should advance the cache query");
assert.match(html, /\/app\.js\?v=136/, "integrated app changes should advance the cache query");
