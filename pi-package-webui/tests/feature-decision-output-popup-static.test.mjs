...
assert.match(html, /\/styles\.css\?v=142/, "integrated stylesheet changes should advance the cache query");
assert.match(html, /\/app\.js\?v=172/, "integrated app changes should advance the cache query");
