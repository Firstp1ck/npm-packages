...
assert.match(html, /\/styles\.css\?v=143/, "integrated stylesheet changes should advance the cache query");
assert.match(html, /\/app\.js\?v=175/, "integrated app changes should advance the cache query");
