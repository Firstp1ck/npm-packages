...
assert.match(html, /\/styles\.css\?v=137/, "integrated stylesheet changes should advance the cache query");
assert.match(html, /\/app\.js\?v=164/, "integrated app changes should advance the cache query");
