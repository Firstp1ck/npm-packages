...
assert.match(html, /\/styles\.css\?v=122/, "integrated stylesheet changes should advance the cache query");
assert.match(html, /\/app\.js\?v=142/, "integrated app changes should advance the cache query");
