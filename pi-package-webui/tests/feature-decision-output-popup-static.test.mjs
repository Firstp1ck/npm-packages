...
assert.match(html, /\/styles\.css\?v=128/, "integrated stylesheet changes should advance the cache query");
assert.match(html, /\/app\.js\?v=149/, "integrated app changes should advance the cache query");
