...
assert.match(html, /\/styles\.css\?v=121/, "integrated stylesheet changes should advance the cache query");
assert.match(html, /\/app\.js\?v=141/, "integrated app changes should advance the cache query");
