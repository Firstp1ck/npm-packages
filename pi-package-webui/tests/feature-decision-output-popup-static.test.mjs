...
assert.match(html, /\/styles\.css\?v=124/, "integrated stylesheet changes should advance the cache query");
assert.match(html, /\/app\.js\?v=147/, "integrated app changes should advance the cache query");
