...
assert.match(html, /\/styles\.css\?v=107/, "integrated stylesheet changes should advance the cache query");
assert.match(html, /\/app\.js\?v=121/, "integrated app changes should advance the cache query");
