...
assert.match(html, /\/styles\.css\?v=123/, "integrated stylesheet changes should advance the cache query");
assert.match(html, /\/app\.js\?v=145/, "integrated app changes should advance the cache query");
