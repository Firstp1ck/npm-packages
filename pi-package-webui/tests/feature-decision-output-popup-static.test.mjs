...
assert.match(html, /\/styles\.css\?v=152/, "integrated stylesheet changes should advance the cache query");
assert.match(html, /\/app\.js\?v=183/, "integrated app changes should advance the cache query");
