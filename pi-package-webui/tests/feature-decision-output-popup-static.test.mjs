...
assert.match(html, /\/styles\.css\?v=113/, "integrated stylesheet changes should advance the cache query");
assert.match(html, /\/app\.js\?v=127/, "integrated app changes should advance the cache query");
