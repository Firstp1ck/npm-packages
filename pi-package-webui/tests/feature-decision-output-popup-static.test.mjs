...
assert.match(html, /\/styles\.css\?v=104/, "integrated stylesheet changes should advance the cache query");
assert.match(html, /\/app\.js\?v=120/, "integrated app changes should advance the cache query");
