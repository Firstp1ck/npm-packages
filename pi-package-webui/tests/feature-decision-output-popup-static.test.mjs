...
assert.match(html, /\/styles\.css\?v=108/, "integrated stylesheet changes should advance the cache query");
assert.match(html, /\/app\.js\?v=122/, "integrated app changes should advance the cache query");
