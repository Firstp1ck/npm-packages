...
assert.match(html, /\/styles\.css\?v=139/, "integrated stylesheet changes should advance the cache query");
assert.match(html, /\/app\.js\?v=168/, "integrated app changes should advance the cache query");
