...
assert.match(html, /\/styles\.css\?v=146/, "integrated stylesheet changes should advance the cache query");
assert.match(html, /\/app\.js\?v=178/, "integrated app changes should advance the cache query");
