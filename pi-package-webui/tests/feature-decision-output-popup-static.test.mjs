...
assert.match(html, /\/styles\.css\?v=130/, "integrated stylesheet changes should advance the cache query");
assert.match(html, /\/app\.js\?v=151/, "integrated app changes should advance the cache query");
