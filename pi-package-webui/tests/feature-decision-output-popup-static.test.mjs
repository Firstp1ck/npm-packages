...
assert.match(html, /\/styles\.css\?v=115/, "integrated stylesheet changes should advance the cache query");
assert.match(html, /\/app\.js\?v=133/, "integrated app changes should advance the cache query");
