...
assert.match(html, /\/styles\.css\?v=145/, "integrated stylesheet changes should advance the cache query");
assert.match(html, /\/app\.js\?v=177/, "integrated app changes should advance the cache query");
