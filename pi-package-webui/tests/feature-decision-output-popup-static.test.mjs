...
assert.match(html, /\/styles\.css\?v=120/, "integrated stylesheet changes should advance the cache query");
assert.match(html, /\/app\.js\?v=139/, "integrated app changes should advance the cache query");
