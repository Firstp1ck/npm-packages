...
assert.match(html, /\/styles\.css\?v=140/, "integrated stylesheet changes should advance the cache query");
assert.match(html, /\/app\.js\?v=169/, "integrated app changes should advance the cache query");
