...
assert.match(html, /\/styles\.css\?v=99/, "integrated stylesheet changes should advance the cache query");
assert.match(html, /\/app\.js\?v=114/, "integrated app changes should advance the cache query");
