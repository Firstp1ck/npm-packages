...
assert.match(html, /\/styles\.css\?v=135/, "integrated stylesheet changes should advance the cache query");
assert.match(html, /\/app\.js\?v=162/, "integrated app changes should advance the cache query");
