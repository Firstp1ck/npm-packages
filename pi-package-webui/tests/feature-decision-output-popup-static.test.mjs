...
assert.match(html, /\/styles\.css\?v=129/, "integrated stylesheet changes should advance the cache query");
assert.match(html, /\/app\.js\?v=150/, "integrated app changes should advance the cache query");
