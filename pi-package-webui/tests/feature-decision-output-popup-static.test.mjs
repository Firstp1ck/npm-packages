...
assert.match(html, /\/styles\.css\?v=112/, "integrated stylesheet changes should advance the cache query");
assert.match(html, /\/app\.js\?v=126/, "integrated app changes should advance the cache query");
