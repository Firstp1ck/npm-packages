...
assert.match(serviceWorker, /pi-webui-pwa-v103/, "PWA cache identity should be bumped for changed browser assets");
assert.match(html, /data-app-src="\/app\.js\?v=141"/, "browser module URL should be cache-busted for Fast-mode wiring");
