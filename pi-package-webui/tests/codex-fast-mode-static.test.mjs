...
assert.match(serviceWorker, /pi-webui-pwa-v132/, "PWA cache identity should be bumped for changed browser assets");
assert.match(html, /data-app-src="\/app\.js\?v=166"/, "browser module URL should be cache-busted for Fast-mode wiring");
