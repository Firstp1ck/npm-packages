...
assert.match(serviceWorker, /pi-webui-pwa-v104/, "PWA cache identity should be bumped for changed browser assets");
assert.match(html, /data-app-src="\/app\.js\?v=142"/, "browser module URL should be cache-busted for Fast-mode wiring");
