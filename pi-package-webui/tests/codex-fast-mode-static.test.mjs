...
assert.match(serviceWorker, /pi-webui-pwa-v60/, "PWA cache identity should be bumped for changed browser assets");
assert.match(html, /data-app-src="\/app\.js\?v=102"/, "browser module URL should be cache-busted for Fast-mode wiring");
