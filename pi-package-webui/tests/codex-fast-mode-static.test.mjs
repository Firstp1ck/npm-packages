...
assert.match(serviceWorker, /pi-webui-pwa-v85/, "PWA cache identity should be bumped for changed browser assets");
assert.match(html, /data-app-src="\/app\.js\?v=122"/, "browser module URL should be cache-busted for Fast-mode wiring");
