...
assert.match(css, /\.terminal-tab-actions \{[\s\S]*flex: 0 0 2rem[\s\S]*\.terminal-tab-split-button,[\s\S]*\.terminal-tab-summary-button \{[\s\S]*flex: 1 1 50%[\s\S]*\.terminal-tab-group-item > \.terminal-tab-actions[\s\S]*\.terminal-tab-close \{/, "Split and Summary should divide the existing compact tab-action slot horizontally");
