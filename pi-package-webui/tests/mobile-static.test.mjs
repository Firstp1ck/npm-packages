...
assert.match(app, /function normalizeFeatureDecisionOutput\(value\) \{\s+return value === "feature_lightweight" \|\| value === "feature_complex" \? value : "";/, "feature decision output normalization should accept only the two approved exact labels");
