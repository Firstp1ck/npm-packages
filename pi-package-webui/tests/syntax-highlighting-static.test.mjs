...
assert.match(serviceWorker, /const CACHE_NAME = "pi-webui-pwa-v145"/, "adding a startup module should advance the PWA cache identity");
assert.match(html, /styles\.css\?v=145/, "new token styles should advance the stylesheet revision");
assert.match(html, /data-app-src="\/app\.js\?v=177"/, "new renderer wiring should advance the app module revision");
