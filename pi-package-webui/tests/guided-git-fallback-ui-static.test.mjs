...
assert.match(html, /data-app-src="\/app\.js\?v=168"/, "the changed browser app should use the next query revision");
assert.match(serviceWorker, /const CACHE_NAME = "pi-webui-pwa-v135";/, "the PWA cache identity should advance with browser behavior");
