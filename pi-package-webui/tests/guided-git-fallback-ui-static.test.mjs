...
assert.match(html, /data-app-src="\/app\.js\?v=172"/, "the changed browser app should use the next query revision");
assert.match(serviceWorker, /const CACHE_NAME = "pi-webui-pwa-v139";/, "the PWA cache identity should advance with browser behavior");
