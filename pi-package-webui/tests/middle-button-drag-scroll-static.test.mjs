...
assert.match(html, /styles\.css\?v=146/, "changed drag-scroll styles should advance the stylesheet revision");
assert.match(html, /app\.js\?v=179/, "changed drag-scroll wiring should advance the app revision");
assert.match(serviceWorker, /const CACHE_NAME = "pi-webui-pwa-v147";[\s\S]*"\/middle-button-drag-scroll\.mjs"/, "offline PWA installs should refresh and cache the new controller module");
