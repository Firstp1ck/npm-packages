...
assert.match(html, /styles\.css\?v=137/, "changed drag-scroll styles should advance the stylesheet revision");
assert.match(html, /app\.js\?v=166/, "changed drag-scroll wiring should advance the app revision");
assert.match(serviceWorker, /const CACHE_NAME = "pi-webui-pwa-v132";[\s\S]*"\/middle-button-drag-scroll\.mjs"/, "offline PWA installs should refresh and cache the new controller module");
