...
assert.match(html, /app\.js\?v=178/, "changed drag-scroll wiring should advance the app revision");
assert.match(serviceWorker, /const CACHE_NAME = "pi-webui-pwa-v146";[\s\S]*"\/middle-button-drag-scroll\.mjs"/, "offline PWA installs should refresh and cache the new controller module");
