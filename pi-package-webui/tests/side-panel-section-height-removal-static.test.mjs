...
assert.match(html, /app\.js\?v=146/, "removing section resize behavior should advance the app revision");
assert.match(serviceWorker, /const CACHE_NAME = "pi-webui-pwa-v108"/, "removing browser assets should advance the PWA cache identity");
