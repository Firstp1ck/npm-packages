...
assert.match(html, /styles\.css\?v=113/, "removing section resize styles should advance the stylesheet revision");
assert.match(html, /app\.js\?v=127/, "removing section resize behavior should advance the app revision");
assert.match(serviceWorker, /const CACHE_NAME = "pi-webui-pwa-v91"/, "removing browser assets should advance the PWA cache identity");
