...
assert.match(html, /styles\.css\?v=108/, "changed composer styles should advance the stylesheet revision");
assert.match(html, /app\.js\?v=122/, "changed composer behavior should advance the app revision");
