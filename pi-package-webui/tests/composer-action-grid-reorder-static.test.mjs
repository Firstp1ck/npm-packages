...
assert.match(html, /styles\.css\?v=117/, "changed composer styles should advance the stylesheet revision");
assert.match(html, /app\.js\?v=136/, "changed composer behavior should advance the app revision");
