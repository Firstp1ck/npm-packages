...
assert.match(html, /styles\.css\?v=124/, "changed composer styles should advance the stylesheet revision");
assert.match(html, /app\.js\?v=147/, "changed composer behavior should advance the app revision");
