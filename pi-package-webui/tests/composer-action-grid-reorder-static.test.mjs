...
assert.match(html, /styles\.css\?v=123/, "changed composer styles should advance the stylesheet revision");
assert.match(html, /app\.js\?v=146/, "changed composer behavior should advance the app revision");
assert.match(serviceWorker, /const CACHE_NAME = "pi-webui-pwa-v108"/, "changed browser assets should advance the PWA cache identity");
