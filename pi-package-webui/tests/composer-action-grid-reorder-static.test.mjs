...
assert.match(html, /styles\.css\?v=128/, "changed composer styles should advance the stylesheet revision");
assert.match(html, /app\.js\?v=149/, "changed composer behavior should advance the app revision");
