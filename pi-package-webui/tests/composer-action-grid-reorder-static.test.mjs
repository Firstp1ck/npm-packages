...
assert.match(html, /styles\.css\?v=132/, "changed composer styles should advance the stylesheet revision");
assert.match(html, /app\.js\?v=157/, "changed composer behavior should advance the app revision");
