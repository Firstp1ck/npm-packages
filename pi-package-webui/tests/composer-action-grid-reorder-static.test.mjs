...
assert.match(html, /styles\.css\?v=145/, "changed composer styles should advance the stylesheet revision");
assert.match(html, /app\.js\?v=177/, "changed composer behavior should advance the app revision");
