...
assert.match(html, /styles\.css\?v=133/, "changed composer styles should advance the stylesheet revision");
assert.match(html, /app\.js\?v=158/, "changed composer behavior should advance the app revision");
