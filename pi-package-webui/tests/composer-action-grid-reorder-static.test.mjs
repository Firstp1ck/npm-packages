...
assert.match(html, /styles\.css\?v=152/, "changed composer styles should advance the stylesheet revision");
assert.match(html, /app\.js\?v=182/, "changed composer behavior should advance the app revision");
