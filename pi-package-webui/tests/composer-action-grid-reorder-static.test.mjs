...
assert.match(html, /styles\.css\?v=99/, "changed composer styles should advance the stylesheet revision");
assert.match(html, /app\.js\?v=114/, "changed composer behavior should advance the app revision");
