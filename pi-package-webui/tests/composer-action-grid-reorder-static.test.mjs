...
assert.match(html, /styles\.css\?v=129/, "changed composer styles should advance the stylesheet revision");
assert.match(html, /app\.js\?v=150/, "changed composer behavior should advance the app revision");
