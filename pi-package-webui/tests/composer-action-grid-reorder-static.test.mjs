...
assert.match(html, /styles\.css\?v=135/, "changed composer styles should advance the stylesheet revision");
assert.match(html, /app\.js\?v=162/, "changed composer behavior should advance the app revision");
