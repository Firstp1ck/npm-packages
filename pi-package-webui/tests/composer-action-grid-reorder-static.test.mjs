...
assert.match(html, /styles\.css\?v=112/, "changed composer styles should advance the stylesheet revision");
assert.match(html, /app\.js\?v=126/, "changed composer behavior should advance the app revision");
