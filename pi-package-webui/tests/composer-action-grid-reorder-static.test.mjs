...
assert.match(html, /styles\.css\?v=120/, "changed composer styles should advance the stylesheet revision");
assert.match(html, /app\.js\?v=139/, "changed composer behavior should advance the app revision");
