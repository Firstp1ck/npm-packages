...
assert.match(html, /styles\.css\?v=106/, "changed composer styles should advance the stylesheet revision");
assert.match(html, /app\.js\?v=121/, "changed composer behavior should advance the app revision");
