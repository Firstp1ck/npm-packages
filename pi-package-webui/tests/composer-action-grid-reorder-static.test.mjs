...
assert.match(html, /styles\.css\?v=146/, "changed composer styles should advance the stylesheet revision");
assert.match(html, /app\.js\?v=178/, "changed composer behavior should advance the app revision");
