...
assert.match(html, /styles\.css\?v=113/, "changed composer styles should advance the stylesheet revision");
assert.match(html, /app\.js\?v=127/, "changed composer behavior should advance the app revision");
