...
assert.match(html, /styles\.css\?v=104/, "changed composer styles should advance the stylesheet revision");
assert.match(html, /app\.js\?v=120/, "changed composer behavior should advance the app revision");
