...
assert.match(html, /styles\.css\?v=140/, "changed composer styles should advance the stylesheet revision");
assert.match(html, /app\.js\?v=169/, "changed composer behavior should advance the app revision");
