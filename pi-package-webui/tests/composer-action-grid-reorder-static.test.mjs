...
assert.match(html, /styles\.css\?v=109/, "changed composer styles should advance the stylesheet revision");
assert.match(html, /app\.js\?v=123/, "changed composer behavior should advance the app revision");
