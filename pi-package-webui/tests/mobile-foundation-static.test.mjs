...
assert.match(serviceWorker, /const CACHE_NAME = "pi-webui-pwa-v84"/, "the cache identity must change with the startup graph");
assert.match(html, /styles\.css\?v=107/, "the stylesheet revision must change with mobile/tablet CSS fixes");
