...
assert.match(html, /styles\.css\?v=142/, "visibility styles should advance the stylesheet query revision");
assert.match(html, /data-app-src="\/app\.js\?v=172"/, "visibility behavior should advance the app query revision");
