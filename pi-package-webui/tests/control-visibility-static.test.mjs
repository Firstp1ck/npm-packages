...
assert.match(
  serviceWorker,
  /const CACHE_NAME = "pi-webui-pwa-v135";/,
  "browser asset changes should advance the PWA cache identity",
);
assert.match(html, /styles\.css\?v=139/, "visibility styles should advance the stylesheet query revision");
assert.match(html, /data-app-src="\/app\.js\?v=168"/, "visibility behavior should advance the app query revision");
