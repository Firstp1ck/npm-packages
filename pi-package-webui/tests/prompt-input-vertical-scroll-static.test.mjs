...
assert.match(html, /styles\.css\?v=145/, "the page should request the six-line prompt stylesheet revision");
assert.match(html, /app\.js\?v=177/, "the page should request the current app revision");
assert.match(serviceWorker, /const CACHE_NAME = "pi-webui-pwa-v145"/, "the PWA cache identity should advance with the prompt scroll assets");
