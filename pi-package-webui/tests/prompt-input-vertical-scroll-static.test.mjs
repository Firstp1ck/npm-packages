...
assert.match(html, /styles\.css\?v=135/, "the page should request the scroll-enabled stylesheet revision");
assert.match(html, /app\.js\?v=162/, "the page should request the scroll-enabled app revision");
assert.match(serviceWorker, /const CACHE_NAME = "pi-webui-pwa-v128"/, "the PWA cache identity should advance with the prompt scroll assets");
