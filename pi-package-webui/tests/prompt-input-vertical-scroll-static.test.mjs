...
assert.match(html, /app\.js\?v=178/, "the page should request the current app revision");
assert.match(serviceWorker, /const CACHE_NAME = "pi-webui-pwa-v146"/, "the PWA cache identity should advance with the prompt scroll assets");
