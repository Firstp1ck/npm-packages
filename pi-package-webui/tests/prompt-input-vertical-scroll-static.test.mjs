...
assert.match(html, /styles\.css\?v=152/, "the page should request the six-line prompt stylesheet revision");
assert.match(html, /app\.js\?v=183/, "the page should request the current app revision");
assert.match(serviceWorker, /const CACHE_NAME = "pi-webui-pwa-v154"/, "the PWA cache identity should advance with the prompt scroll assets");
