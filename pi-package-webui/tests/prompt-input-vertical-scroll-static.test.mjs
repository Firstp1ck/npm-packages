...
assert.match(html, /styles\.css\?v=133/, "the page should request the scroll-enabled stylesheet revision");
assert.match(html, /app\.js\?v=158/, "the page should request the scroll-enabled app revision");
assert.match(serviceWorker, /const CACHE_NAME = "pi-webui-pwa-v124"/, "the PWA cache identity should advance with the prompt scroll assets");
