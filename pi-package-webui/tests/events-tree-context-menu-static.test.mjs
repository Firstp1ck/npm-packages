...
assert.match(serviceWorker, /const CACHE_NAME = "pi-webui-pwa-v147";/, "the PWA cache identity should advance");
assert.match(html, /styles\.css\?v=146/, "compact-mode styles should advance the stylesheet revision");
assert.match(html, /data-app-src="\/app\.js\?v=179"/, "the app query revision should advance");
