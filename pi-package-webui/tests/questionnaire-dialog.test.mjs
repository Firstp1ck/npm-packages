...
assert.match(html, /styles\.css\?v=145/, "questionnaire CSS needs the current stylesheet revision");
assert.match(html, /app\.js\?v=177/, "questionnaire behavior needs the current app revision");
assert.match(serviceWorker, /const CACHE_NAME = "pi-webui-pwa-v145"/, "questionnaire public assets need a coherent PWA cache revision");
