...
assert.match(html, /app\.js\?v=156/, "questionnaire behavior needs the current app revision");
assert.match(serviceWorker, /const CACHE_NAME = "pi-webui-pwa-v122"/, "questionnaire public assets need a coherent PWA cache revision");
