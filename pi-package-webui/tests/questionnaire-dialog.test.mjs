...
assert.match(html, /styles\.css\?v=99/, "questionnaire CSS needs the current stylesheet revision");
assert.match(html, /app\.js\?v=114/, "questionnaire behavior needs the current app revision");
assert.match(serviceWorker, /const CACHE_NAME = "pi-webui-pwa-v75"/, "questionnaire public assets need a coherent PWA cache revision");
