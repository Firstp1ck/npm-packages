...
assert.match(html, /styles\.css\?v=143/, "questionnaire CSS needs the current stylesheet revision");
assert.match(html, /app\.js\?v=176/, "questionnaire behavior needs the current app revision");
assert.match(serviceWorker, /const CACHE_NAME = "pi-webui-pwa-v143"/, "questionnaire public assets need a coherent PWA cache revision");
