...
assert.match(html, /styles\.css\?v=126/, "questionnaire CSS needs the current stylesheet revision");
assert.match(html, /app\.js\?v=148/, "questionnaire behavior needs the current app revision");
assert.match(serviceWorker, /const CACHE_NAME = "pi-webui-pwa-v112"/, "questionnaire public assets need a coherent PWA cache revision");
