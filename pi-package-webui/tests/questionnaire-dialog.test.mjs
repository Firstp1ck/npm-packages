...
assert.match(html, /styles\.css\?v=140/, "questionnaire CSS needs the current stylesheet revision");
assert.match(html, /app\.js\?v=169/, "questionnaire behavior needs the current app revision");
assert.match(serviceWorker, /const CACHE_NAME = "pi-webui-pwa-v136"/, "questionnaire public assets need a coherent PWA cache revision");
