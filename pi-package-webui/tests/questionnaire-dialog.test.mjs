...
assert.match(html, /styles\.css\?v=113/, "questionnaire CSS needs the current stylesheet revision");
assert.match(html, /app\.js\?v=127/, "questionnaire behavior needs the current app revision");
assert.match(serviceWorker, /const CACHE_NAME = "pi-webui-pwa-v91"/, "questionnaire public assets need a coherent PWA cache revision");
