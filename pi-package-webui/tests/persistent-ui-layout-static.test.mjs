...
assert.match(html, /styles\.css\?v=142/, "the page should request the updated layout stylesheet revision");
assert.match(html, /data-app-src="\/app\.js\?v=172"/, "the boot loader should request the updated app module revision");
