...
assert.match(html, /styles\.css\?v=106/, "the page should request the updated layout stylesheet revision");
assert.match(html, /data-app-src="\/app\.js\?v=121"/, "the boot loader should request the updated app module revision");
