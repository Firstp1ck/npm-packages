...
assert.match(server, /operation\.type === "delete"[\s\S]*queue\.splice\(slots\[operation\.index\], 1\)/, "compaction deletion should remove the selected complete queued command record");
