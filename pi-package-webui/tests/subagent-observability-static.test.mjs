...
assert.match(html, /styles\.css\?v=123[\s\S]*app\.js\?v=143/, "browser assets should use the WS-D revisions");
assert.match(worker, /pi-webui-pwa-v105/, "PWA cache identity should advance with WS-D browser assets");
