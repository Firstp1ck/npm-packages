...
assert.match(html, /styles\.css\?v=131[\s\S]*app\.js\?v=156/, "browser assets should use the current subagent-observability revisions");
assert.match(worker, /pi-webui-pwa-v122/, "PWA cache identity should advance with subagent widget suppression");
