...
assert.match(html, /styles\.css\?v=140[\s\S]*app\.js\?v=169/, "browser assets should use the current subagent-observability revisions");
assert.match(worker, /pi-webui-pwa-v136/, "PWA cache identity should advance with subagent widget suppression");
