...
assert.match(html, /styles\.css\?v=135[\s\S]*app\.js\?v=162/, "browser assets should use the current subagent-observability revisions");
assert.match(worker, /pi-webui-pwa-v128/, "PWA cache identity should advance with subagent widget suppression");
