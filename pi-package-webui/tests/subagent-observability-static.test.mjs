...
assert.match(html, /styles\.css\?v=122[\s\S]*app\.js\?v=142/, "browser assets should use the WS-D revisions");
assert.match(worker, /pi-webui-pwa-v104/, "PWA cache identity should advance with WS-D browser assets");
