...
assert.match(html, /styles\.css\?v=152[\s\S]*app\.js\?v=182/, "browser assets should use the current subagent-observability revisions");
assert.match(worker, /pi-webui-pwa-v153/, "PWA cache identity should advance with subagent widget suppression");
