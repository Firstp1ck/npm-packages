...
assert.match(html, /styles\.css\?v=146[\s\S]*app\.js\?v=178/, "browser assets should use the current subagent-observability revisions");
assert.match(worker, /pi-webui-pwa-v146/, "PWA cache identity should advance with subagent widget suppression");
