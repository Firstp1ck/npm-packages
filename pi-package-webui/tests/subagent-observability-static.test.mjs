...
assert.match(html, /styles\.css\?v=127[\s\S]*app\.js\?v=148/, "browser assets should use the current subagent-observability revisions");
assert.match(worker, /pi-webui-pwa-v113/, "PWA cache identity should advance with subagent widget suppression");
