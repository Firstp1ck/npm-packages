...
assert.match(html, /styles\.css\?v=145[\s\S]*app\.js\?v=177/, "browser assets should use the current subagent-observability revisions");
assert.match(worker, /pi-webui-pwa-v145/, "PWA cache identity should advance with subagent widget suppression");
