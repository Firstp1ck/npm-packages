...
assert.match(html, /styles\.css\?v=142[\s\S]*app\.js\?v=172/, "browser assets should use the current subagent-observability revisions");
assert.match(worker, /pi-webui-pwa-v139/, "PWA cache identity should advance with subagent widget suppression");
