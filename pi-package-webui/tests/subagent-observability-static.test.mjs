...
assert.match(html, /styles\.css\?v=139[\s\S]*app\.js\?v=168/, "browser assets should use the current subagent-observability revisions");
assert.match(worker, /pi-webui-pwa-v135/, "PWA cache identity should advance with subagent widget suppression");
