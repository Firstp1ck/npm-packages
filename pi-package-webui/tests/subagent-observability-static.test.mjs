...
assert.match(html, /styles\.css\?v=128[\s\S]*app\.js\?v=149/, "browser assets should use the current subagent-observability revisions");
assert.match(worker, /pi-webui-pwa-v114/, "PWA cache identity should advance with subagent widget suppression");
