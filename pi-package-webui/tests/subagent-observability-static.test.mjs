...
assert.match(html, /styles\.css\?v=117[\s\S]*app\.js\?v=136/, "browser assets should use the WS-D revisions");
assert.match(worker, /pi-webui-pwa-v98/, "PWA cache identity should advance with WS-D browser assets");
