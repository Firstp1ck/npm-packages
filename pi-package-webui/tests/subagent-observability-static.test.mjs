...
assert.match(html, /styles\.css\?v=146[\s\S]*app\.js\?v=179/, "browser assets should use the current subagent-observability revisions");
assert.match(worker, /pi-webui-pwa-v147/, "PWA cache identity should advance with subagent widget suppression");
