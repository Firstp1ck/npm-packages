...
assert.match(html, /styles\.css\?v=137[\s\S]*app\.js\?v=166/, "browser assets should use the current subagent-observability revisions");
assert.match(worker, /pi-webui-pwa-v132/, "PWA cache identity should advance with subagent widget suppression");
