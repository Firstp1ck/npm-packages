...
assert.match(html, /styles\.css\?v=115[\s\S]*app\.js\?v=132/, "browser assets should use the WS-D revisions");
assert.match(worker, /pi-webui-pwa-v94/, "PWA cache identity should advance with WS-D browser assets");
