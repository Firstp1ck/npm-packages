...
assert.match(html, /styles\.css\?v=132[\s\S]*app\.js\?v=157/, "browser assets should use the current subagent-observability revisions");
assert.match(worker, /pi-webui-pwa-v123/, "PWA cache identity should advance with subagent widget suppression");
