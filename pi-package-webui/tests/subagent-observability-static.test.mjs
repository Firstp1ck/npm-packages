...
assert.match(html, /styles\.css\?v=133[\s\S]*app\.js\?v=158/, "browser assets should use the current subagent-observability revisions");
assert.match(worker, /pi-webui-pwa-v124/, "PWA cache identity should advance with subagent widget suppression");
