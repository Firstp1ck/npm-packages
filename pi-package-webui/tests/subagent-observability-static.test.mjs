...
assert.match(html, /styles\.css\?v=143[\s\S]*app\.js\?v=173/, "browser assets should use the current subagent-observability revisions");
assert.match(worker, /pi-webui-pwa-v140/, "PWA cache identity should advance with subagent widget suppression");
