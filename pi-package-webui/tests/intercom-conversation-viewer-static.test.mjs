...
assert.match(html, /\/styles\.css\?v=122/, "the stylesheet URL should advance for the accepted viewer fixes");
assert.match(html, /data-app-src="\/app\.js\?v=142"/, "the guarded app URL should advance for incremental viewer wiring");
assert.match(serviceWorker, /const CACHE_NAME = "pi-webui-pwa-v104"/, "the PWA cache identity should advance with browser assets");
