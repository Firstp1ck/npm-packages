...
assert.match(html, /\/styles\.css\?v=143/, "the stylesheet URL should advance for the bounded conversation tags");
assert.match(html, /data-app-src="\/app\.js\?v=173"/, "the guarded app URL should advance for current browser wiring");
assert.match(serviceWorker, /const CACHE_NAME = "pi-webui-pwa-v140"/, "the PWA cache identity should advance with browser assets");
