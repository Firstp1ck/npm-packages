...
assert.match(html, /\/styles\.css\?v=142/, "the stylesheet URL should advance for the bounded conversation tags");
assert.match(html, /data-app-src="\/app\.js\?v=172"/, "the guarded app URL should advance for current browser wiring");
