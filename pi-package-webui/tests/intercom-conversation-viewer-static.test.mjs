...
assert.match(html, /data-app-src="\/app\.js\?v=156"/, "the guarded app URL should advance for current browser wiring");
assert.match(serviceWorker, /const CACHE_NAME = "pi-webui-pwa-v122"/, "the PWA cache identity should advance with browser assets");
