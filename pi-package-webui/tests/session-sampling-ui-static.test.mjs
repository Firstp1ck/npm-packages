...
assert.match(serviceWorker, /const CACHE_NAME = "pi-webui-pwa-v139"/, "native-control assets should advance the cache identity");
...
assert.match(html, /styles\.css\?v=142/, "the changed stylesheet should have a new revision");
assert.match(html, /app\.js\?v=172/, "the changed app module should have a new revision");
