...
assert.match(serviceWorker, /const CACHE_NAME = "pi-webui-pwa-v145"/, "native-control assets should advance the cache identity");
...
assert.match(html, /styles\.css\?v=145/, "the changed stylesheet should have a new revision");
assert.match(html, /app\.js\?v=177/, "the changed app module should have a new revision");
