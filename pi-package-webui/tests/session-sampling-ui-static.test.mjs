...
assert.match(serviceWorker, /const CACHE_NAME = "pi-webui-pwa-v113"/, "native-control assets should advance the cache identity");
...
assert.match(html, /styles\.css\?v=127/, "the changed stylesheet should have a new revision");
