...
assert.match(serviceWorker, /const CACHE_NAME = "pi-webui-pwa-v91"/, "native-control assets should advance the cache identity");
...
assert.match(html, /styles\.css\?v=113/, "the changed stylesheet should have a new revision");
assert.match(html, /app\.js\?v=127/, "the changed app module should have a new revision");
