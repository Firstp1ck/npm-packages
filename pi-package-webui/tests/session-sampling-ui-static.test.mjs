...
assert.match(serviceWorker, /const CACHE_NAME = "pi-webui-pwa-v142"/, "native-control assets should advance the cache identity");
...
assert.match(html, /app\.js\?v=175/, "the changed app module should have a new revision");
