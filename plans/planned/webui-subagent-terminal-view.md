...
| `plans/planned/webui-subagent-terminal-view.md` | Canonical execution/review record |
...
- `git diff --check -- pi-package-webui plans/planned/webui-subagent-terminal-view.md` — **passed**.
